...
# 2 "<built-in>" 2
# 1 "SourceFiles/COS/COS_Main.c" 2
# 10 "SourceFiles/COS/COS_Main.c"
...
# 10 "SourceFiles/COS/COS_Main.c" 2
...
UINT_16 COS_ms_tmr;
volatile UINT_16 COS_sec_tmr;
UINT_16 COS_tsk_tmr;
UINT_16 COS_tcnt_val;
UINT_16 COS_tcnt_lst;
# 32 "SourceFiles/COS/COS_Main.c"
void COS_Init(void)
{
...
void COS_TmrHandler(void)
{
 ...
 if (((UINT_16) ((UINT_16) COS_tcnt_val - (UINT_16) COS_tcnt_lst) >= (UINT_16) 1000))
 {
  COS_tcnt_lst = COS_tcnt_lst + 1000;
  COS_ms_tmr++;
...
# 133 "SourceFiles/COS/COS_Main.c"
void COS_TskMan(void)
{
